...
export const ViajesIntegrado = ({ usuario, onReservaExitosa }) => {
  ...
  const buscarVuelos = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/viajes/vuelos`, {
  ...
  const buscarHoteles = async () => {
    try {
      const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/viajes/hoteles`, {
  ...
  const handleReservar = async () => {
    ...
    setReservando(true);
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/viajes/reservas`, {
